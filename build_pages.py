      ...
      <div class="form-shell">
        <form id="sitter-form" novalidate>
          ...
          <div class="form-section form-section--final">
            <div class="form-section__title">Final step &middot; Verify your identity with Smile ID</div>
            ...
            <div class="smile-id-placeholder">
              <div class="smile-id-placeholder__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M9 10h.01M15 10h.01M8.5 14.5c1 1 2.2 1.5 3.5 1.5s2.5-.5 3.5-1.5"/></svg>
              </div>
              <div class="smile-id-placeholder__body">
                <strong>Smile ID identity check</strong>
                <p>This is where document + facial-liveness verification will run automatically once Elite Traders Lounge's Smile ID account is connected. For now, our team manually confirms your identity using the ID document you uploaded above.</p>
              </div>
              <span class="badge-verified badge-verified--pending"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>Coming soon</span>
            </div>
            <div class="checkbox-field">
              <input type="checkbox" id="smile_id_consent" name="smile_id_consent" required />
              <label for="smile_id_consent">I consent to Smile ID verifying my identity (document check + facial liveness) once this step is activated.</label>
            </div>
          </div>
    ...
    <div class="container container--narrow">
      <div class="form-shell">
        <form id="booking-form" novalidate>
          ...
          <div class="form-section form-section--final">
            <div class="form-section__title">Final step &middot; Verify your identity with Smile ID</div>
            <div class="form-section__hint">Elite Traders Lounge partners with Smile ID to confirm your identity before a babysitter is placed in your home.</div>
            <div class="smile-id-placeholder">
              <div class="smile-id-placeholder__icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M9 10h.01M15 10h.01M8.5 14.5c1 1 2.2 1.5 3.5 1.5s2.5-.5 3.5-1.5"/></svg>
              </div>
